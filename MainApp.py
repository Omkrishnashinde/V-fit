...
if selected=='Home':
    ...
    expander_faq.write("V-fit is a  for yoga pose detection and accuracy feedback using CNN and OpenPose sounds very interesting and innovative. With this project, you have developed a solution that can help people improve their yoga practice by providing them with real-time feedback on their pose accuracy.")
    ...
    if app_mode =='Tada Asana':
        ...
        import os
        st.sidebar.write(" ------ ")
        st.subheader("We are Team V-Fit !!")
        first_column, second_column, third_column, forth_column,  = st.columns(4)
        first_column.image(os.path.join('meet_team/shubh.png'),    use_column_width = True, caption = "Om Shinde")
        second_column.image(os.path.join('meet_team/manu.png'),    use_column_width = True, caption = "Shrinivas Nagergoje")
        third_column.image(os.path.join('meet_team/WhatsApp Image 2022-04-22 at 3.57.55 PM.png'),  use_column_width = True, caption = "Pranav Tapdiya")
        forth_column.image(os.path.join('meet_team/ayush.png'),  use_column_width = True, caption = "Adesh Shinde")
        ...
        expandar_linkedin.write('om: om.shinde19@pccoepune.org')
        expandar_linkedin.write('Shrinivas: shrinivas19@pccoepune.org')
        expandar_linkedin.write('Pranav: pranav19@pccoepune.org')
        expandar_linkedin.write('Adesh: adesh19@pccoepune.org')
